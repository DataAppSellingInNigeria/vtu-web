...
export default function BuyCablePage() {
    ...
    async function onSubmit(e: FormEvent) {
        ...
        setLoading(true);
        try {
            // Backend returns { message, data: response } for cable recharge :contentReference[oaicite:2]{index=2}
            const payload = {
            ...
            setServerMsg(res?.data?.message || "Cable subscription successful.");
