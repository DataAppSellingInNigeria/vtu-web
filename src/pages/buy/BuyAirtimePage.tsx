...
export default function BuyAirtimePage() {
    ...
    async function onSubmit(e: FormEvent) {
        ...
        setLoading(true);
        try {
            // Backend returns { message, data: vtuResponse } for airtime purchases :contentReference[oaicite:1]{index=1}
            const res = await API.post("/services/airtime", { network, phone: to234(phone), amount: total });
            setServerMsg(res?.data?.message || "Airtime sent successfully.");
